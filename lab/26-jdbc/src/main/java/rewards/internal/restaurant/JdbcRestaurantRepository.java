...
//
//		return restaurant;
//		return jdbcTemplate.queryForObject(sql, new Object[]{merchantNumber}, (rs, rowNum) -> mapRestaurant(rs));
		...
		return (Restaurant) jdbcTemplate.queryForObject(sql, new Object[]{merchantNumber}, rowMapper);
	}
